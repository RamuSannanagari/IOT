...
aggTableHeaders=[];
  ...
  //get substation list
  getSubstationList() {
    this.subscription['getsubstationList'] = this.apiService.getSubStationList('STREET_LIGHT').subscribe(res=>{
        this.subSationList = res.STREET_LIGHT;
    })
  }
  ...
  export() {
    const csvExporter = new ExportToCsv( { 
        ...
        headers: ['Date', 'Device Id', 'Average Powerfactor', 'Average Voltage','Current', 'Power Consumption','Device Name'] 
      });
